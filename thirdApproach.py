...
def readCSV():
    ...
    with open("/Users/Rick/Desktop/projectFinalFolder/segments/customerQuarterSalesDict.yaml", 'w' ) as f:
...
def selectIncreasedTrendCustomer():
    ...
    with open('/Users/Rick/Desktop/projectFinalFolder/segments/topCompleteHouseHoldList.yaml', 'r' ) as f:
