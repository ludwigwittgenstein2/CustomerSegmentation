...
#   Total Sales by each Customer#
    with open("/Users/Rick/Desktop/projectFinalFolder/segments/customerSaleDict.yaml", 'w') as f:
		f.write(yaml.dump(customerSaleDict,default_flow_style=False))
    f.close()
#   Total Sales of each Customer in 4 quarters#
    with open("/Users/Rick/Desktop/projectFinalFolder/segments/customerQuarterSaleDict.yaml", 'w' ) as f:
...
def buildCompleteTopCustomer():
    ...
    for houseHoldKey, saleValue in sorted(customerSaleDict.items(), key=lambda k:k[1],reverse=True):
...
def selectCustomerOverTrend():
    ...
    with open("/Users/Rick/Desktop/projectFinalFolder/segments/customerQuarterSaleDict.yaml", 'r' ) as f:
        customerQuarterSaleDict =  yaml.load(f)
    f.close()

    with open('/Users/Rick/Desktop/projectFinalFolder/segments/topCompleteHouseHoldList', 'r' ) as f:
    ...
    with open('/Users/Rick/Desktop/projectFinalFolder/segments/moreSpentOverTime.yaml', 'w' ) as f:
	f.write(yaml.dump(moreSpentOverTime,default_flow_style=False))
    f.close()

    with open('/Users/Rick/Desktop/projectFinalFolder/segments/lessSpentOverTime.yaml', 'w' ) as f:
